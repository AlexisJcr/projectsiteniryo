...
function burgerclic() {
  ...
  var burgerItems = document.querySelector(".navbar-burger-items");
  var logoNiryo = document.querySelector(".navbar-logo")
  if (navContainer.style.height === "60px")
  {
    navContainer.style.height = "750px";
    burgerItems.style.display = "flex";
    logoNiryo.style.display = "none";

  }
  else{
    navContainer.style.height = "60px";
    burgerItems.style.display = "none";
    logoNiryo.style.display = "flex";
  }
}
...
// Obtient l'élément .nav-container
var navContainer = document.querySelector(".nav-container");

// Vérifie si le paramètre de requête "background" existe
var background = new URLSearchParams(window.location.search).get("background");

// Si le paramètre de requête "background" existe, applique le style "linear-gradient"
if (background) {
